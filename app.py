...
.weather-hero {
    ...
    box-shadow:
        0 14px 34px rgba(23,105,185,.20);
...
with left:
    ...
    if risk_level == "good":
        ...
        <div class="status status-warning">
            ...
            <div class="status-detail">
                You can go outside,
                but take the recommended precautions.
            </div>
        ...
        <div class="status status-danger">
            ...
            <div class="status-detail">
                ...
                activities and follow local guidance.
            </div>
    ...
    if activity == "🏃 Running":
        ...
        if temperature >= 35 or feels_like >= 38:
            ...
            activity_advice = (
                "🌧️ Consider postponing your run "
                "because rain is likely."
            )
...
with middle:
    ...
    st.markdown(
        f"""
        <div class="card"
             style="background:#FFF9EC !important;">
...
with right:
    ...
    if temperature >= 40 or feels_like >= 42:
        ...
        ai_message += (
            "It is hot outside, so limit prolonged "
            "exposure and carry water. "
        )
    ...
    daily_plan = [
        ...
        (
            "☀️",
            "12:00 PM – 4:00 PM",
            "Avoid long exposure if UV/heat is high"
        ),
...
for i in range(7):
    ...
    try:
        ...
        date_name = datetime.fromisoformat(
            day
        ).strftime("%d %b")
